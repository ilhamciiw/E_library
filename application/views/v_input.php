...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-4">
				<form action="<?php echo base_url(). 'index.php/admin/registrasi'; ?>" method="post">
					<table style="margin:20px auto;">
						<tr>
							<td>Nomor Induk</td>
							<td>
								<div class="input-group">
									<input class="form-control" type="text" name="username" aria-describedby="basic-addon1">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group">
									<input class="form-control" type="text" name="nama" aria-describedby="basic-addon1">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group">
									<input class="form-control" type="text" name="alamat" aria-describedby="basic-addon1">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group">
									<input class="form-control" type="text" name="e-mail" aria-describedby="basic-addon1">
								</div>	
							</td>
						</tr>
									<tr>
							...
							<td>
								<div class="input-group">
									<input class="form-control" type="password" name="password" aria-describedby="basic-addon1">
								</div>	
							</td>
						</tr>
						<tr>
