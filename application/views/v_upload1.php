				...
				<form action="<?php echo base_url(). 'crud/tambah_aksi'; ?>" method="post">
					<table style="margin:20px auto;">
						...
						<tr>
							...
							<td>
								<div class="input-group">
									<input class="form-control" type="text" name="id_video" aria-describedby="basic-addon1">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group">
									<input class="form-control" type="text" name="judul_video" aria-describedby="basic-addon1">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group">
									<input class="form-control" type="text" name="sumber" aria-describedby="basic-addon1">
								</div>	
							</td>
						</tr>
						<tr>
						<td>Keterangan</td>
							<td>
								<div class="input-group">
									<input class="form-control" type="text" name="kategori" aria-describedby="basic-addon1">
								</div>
							</td>
						</tr>
						<tr>
